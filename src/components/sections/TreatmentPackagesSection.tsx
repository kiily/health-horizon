...
export function TreatmentPackagesSection() {
	const packages = [
		{
			id: 1,
			name: 'Complete Urology Package',
			location: 'Lisbon, Portugal',
			image:
				'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=500&h=400&fit=crop',
			rating: 4.9,
			reviews: 850,
			originalPrice: 4000,
			packagePrice: 1800,
		...
		{
			id: 2,
			name: 'Aesthetic Medicine Package',
			location: 'Lisbon, Portugal',
			image:
		...
		{
			id: 3,
			name: 'Gastroenterology Excellence',
			location: 'Lisbon, Portugal',
			image:
			...
			highlight: 'State-of-Art Equipment',
			badge: 'expert',
		},
		{
			id: 4,
			...
			location: 'Lisbon, Portugal',
			image:
				'https://images.unsplash.com/photo-1576089172869-4f5f6f315620?w=500&h=400&fit=crop',
			rating: 4.8,
			reviews: 920,
			originalPrice: 3500,
			packagePrice: 1600,
